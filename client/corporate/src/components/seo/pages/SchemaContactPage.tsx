    ...
    "@graph": [
      {
        ...
        openingHoursSpecification: [
          ...
          {
            "@type": "OpeningHoursSpecification",
            dayOfWeek: siteConfig?.weekendSaturdays || ["Saturday"],
            opens: siteConfig.openingHours?.saturday?.open || "09:00",
            closes: siteConfig.openingHours?.saturday?.close || "14:00",
          },
          ,
          {
            "@type": "OpeningHoursSpecification",
            dayOfWeek: siteConfig?.weekendSundays || ["Sunday"],
            opens: siteConfig.openingHours?.sunday?.open || "12:00",
            closes: siteConfig.openingHours?.sunday?.close || "20:00",
          },
        ],
        contactPoint: [
          {

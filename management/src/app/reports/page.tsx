...
export default function ReportsPage() {
  ...
  const totalProposals = monthlyData.reduce((sum, month) => sum + month.proposals, 0);
    ...
    <div>
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold leading-6 text-gray-900">Raporlar</h1>
      ...
      {/* Key Metrics */}
      <div className="mt-8">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Yıllık Özet (2024)</h3>
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-4">
          ...
          <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
            <dt className="truncate text-sm font-medium text-gray-500">Tamamlanan Proje</dt>
          ...
          <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
            ...
            <dd className="mt-1 text-3xl font-semibold tracking-tight text-gray-900">{totalProposals}</dd>
          </div>
          <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
            <dt className="truncate text-sm font-medium text-gray-500">Ortalama Proje Değeri</dt>
            <dd className="mt-1 text-3xl font-semibold tracking-tight text-gray-900">
      ...
      <div className="mt-8">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Aylık Performans</h3>
      ...
      {/* Monthly Data Table */}
      <div className="mt-8">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Aylık Detay Veriler</h3>
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {monthlyData.map((month, index) => (
                <tr key={index}>
                  ...
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{month.projects}</td>
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                    {month.revenue.toLocaleString('tr-TR')} ₺
                  </td>
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{month.proposals}</td>
                  <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2">
          {reports.map((report) => (
            <div key={report.id} className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
